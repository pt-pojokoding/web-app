...
// Method to scroll to the active link
                ...
                <NuxtLink :to="`/kursus/${courseSlug}/${content.slug.current}`" :data-cy="`sidebar-content-link-${content._id}`">
                    ...
                    >
                        <UIcon
                            ...
                            data-cy="sidebar-content-type-icon"
                        ></UIcon>
                        <span class="col-span-10 ml-2" data-cy="sidebar-content-title">{{ content.displayTitle }}</span>
                        <UIcon
